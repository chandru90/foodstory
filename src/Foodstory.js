...
const FoodStory = ({ locale }) => {
  ...
  const sections = [
    {
      id: "intro-cover",
      bgImages: ["foodstories.png"],
      mobbgImages: ["foodstories.png"],
    },
...

    {
      ...
      description: "mindfuleating.description",
      bgImages: [
        "foodexperience/img3.jpg",
        "foodexperience/img6.jpg",
        "foodexperience/img8.jpg",
        "foodexperience/img12.jpg",
        "foodexperience/img15.jpg",
      ],
    },

    {
      id: "The Evolution of Food: A Journey Through Human History",
      title: "evolution.title",
      description: "evolution.description",
      bgImages: [
        "evoloffood/img9.jpg",
        "evoloffood/img2.jpg",
        "evoloffood/img10.jpg",
        "evoloffood/img1.webp",
        "evoloffood/img10.jpg",
        "evoloffood/img7.jpeg",
        "evoloffood/images8.jpg",
        "evoloffood/img2.jpeg",
        "evoloffood/images3.jpg",
        "evoloffood/img13.jpeg",
        "evoloffood/images14.jpg",
      ],
    },
...

    {
      ...
      mobbgImages: [
        "civiliz/mobimg/img1.jpg",
        "civiliz/mobimg/img2.jpg",
        "civiliz/mobimg/img3.jpg",
        "civiliz/mobimg/img4.jpg",
        "civiliz/mobimg/img5.jpg",
      ],
    },
...

    {
      ...
      description: "vit.description",
      bgImages: [
        "storyofvitamins/img3.jpg",
        "storyofvitamins/img6.jpg",
        "storyofvitamins/img8.jpg",
        "storyofvitamins/img12.jpg",
        "storyofvitamins/img15.jpg",
      ],
    },
...

    {
      ...
      description: "cooking.description",
      bgImages: [
        "cookingandkitchens/img3.jpg",
        "cookingandkitchens/img6.jpg",
        "cookingandkitchens/img8.jpg",
        "cookingandkitchens/img12.jpg",
        "cookingandkitchens/img15.jpg",
      ],
    },

    {
      ...
      description: "travel.description",
      bgImages: [
        "foodandtravel/img3.jpg",
        "foodandtravel/img6.jpg",
        "foodandtravel/img8.jpg",
        "foodandtravel/img12.jpg",
        "foodandtravel/img15.jpg",
      ],
    },
...

    {
      ...
      description: "future.description",
      bgImages: [
        "futureoffood/img1.jpg",
        "futureoffood/img2.jpg",
        "futureoffood/img3.jpg",
        "futureoffood/img4.jpg",
        "futureoffood/img5.jpg",
      ],
    },

    {
      ...
      description: "eco.description",
      bgImages: [
        "foodsandeconomics/img1.jpg",
        "foodsandeconomics/img2.jpg",
        "foodsandeconomics/img3.jpg",
        "foodsandeconomics/img4.jpg",
        "foodsandeconomics/img5.jpg",
      ],
    },
...

    {
      ...
      description: "cookingtherapy.description",
      bgImages: [
        "cookingastherapy/img1.jpg",
        "cookingastherapy/img2.jpg",
        "cookingastherapy/img3.jpg",
        "cookingastherapy/img4.jpg",
        "cookingastherapy/img5.jpg",
      ],
    },

    {
      ...
      description: "cookinglove.description",
      bgImages: [
        "emotionalpowerofcooking/img1.jpg",
        "emotionalpowerofcooking/img2.jpg",
        "emotionalpowerofcooking/img3.jpg",
        "emotionalpowerofcooking/img4.jpg",
        "emotionalpowerofcooking/img5.jpg",
        "emotionalpowerofcooking/img6.jpg",
        "emotionalpowerofcooking/img7.jpg",
        "emotionalpowerofcooking/img8.jpg",
      ],
    },

    {
      ...
      description: "foodmemories.description",
      bgImages: [
        "foodandmemory/img3.jpg",
        "foodandmemory/img6.jpg",
        "foodandmemory/img8.jpg",
        "foodandmemory/img12.jpg",
        "foodandmemory/img15.jpg",
      ],
    },
  ];
  ...
  const speakText = (text, id) => {
    ...
    const wordsPerSecond = 2.5;
    const duration = Math.ceil(words.length / wordsPerSecond);
    ...
    utterance.onboundary = (event) => {
      ...
      const wordIndex = spokenText.trim()
        ? spokenText.trim().split(/\s+/).length - 1
        : 0;

      setCurrentWordIndex(wordIndex);

      // ----------------------------------------------------------
      // Automatically scroll highlighted word into view
      // ----------------------------------------------------------

      const wordElement = document.querySelector(
        `[data-speech-word="${id}-${wordIndex}"]`
      );
    ...
    if (section.bgImages && section.bgImages.length > 1) {
      imageInterval.current = setInterval(() => {
        setCurrentBg((prev) => {
          return (prev + 1) % section.bgImages.length;
        });
      }, 40000);
    }
  ...
  const resumeSpeech = () => {
    ...
    const section = sections.find(
      (item) => item.id === speakingId
    );

    if (section && section.bgImages?.length > 1) {
      imageInterval.current = setInterval(() => {
        setCurrentBg((prev) => {
          return (prev + 1) % section.bgImages.length;
        });
  ...
  // ============================================================
  // RENDER DESCRIPTION WITH WORD HIGHLIGHT
  // ============================================================
  ...
  const renderHighlightedText = (item) => {
    ...
    /*
     * Split while preserving spaces and line breaks.
     */
    ...
    return parts.map((part, index) => {
      ...
      return (
        <span
          key={`${item.id}-${index}`}
          data-speech-word={`${item.id}-${currentIndex}`}
          className={`
            transition-all
            duration-150
            rounded
  ...
  const previousSection = () => {
    ...
    setActiveSection((prev) => {
      return prev === 0 ? sections.length - 1 : prev - 1;
    });
  };
      ...
      <div>
        ...
        >
          ...
          >
            ...
            {!item.title && (
              <div className="relative z-10 w-full h-full min-h-[70vh] flex items-center justify-center">
                {/* Cover image is already the background */}
              </div>
            )}
            ...
            {item.title && (
              ...
              >
                ...
                <div
                  ...
                  "
                >
                  <p className="food-title whitespace-pre-line">
