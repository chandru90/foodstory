          ...
          <div className="relative grid lg:grid-cols-2 items-center min-h-[620px]">
            ...
            <div className="p-8 sm:p-12 lg:p-16 text-white">
              ...
              <p className="mt-6 text-lg leading-8 text-green-100 max-w-xl">
                 Foodstorys explores why food matters to people: the memories it creates, the traditions it carries, the communities it connects, and the role it plays in our health and well-being.
              </p>
